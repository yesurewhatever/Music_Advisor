                ...
                authTestCase("new")
                        ...
                        .addInput(reply -> {
                            if (!reply.contains("No more pages")) {
                                return CheckResult.FALSE("Your output should be `No more pages` on -1 page.");
                            }
                            return "next";
                        })
                        .addInput(reply -> {
                        ...
                        .addInput(reply -> {
                            if (!reply.contains("No more pages")) {
                                return CheckResult.FALSE("Your output should be `No more pages` after the last page.");
                            }
                            return "prev";
                        })
                        .addInput(reply -> {
